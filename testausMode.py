              ...
              #  print("Choose your next action:\n")
                ...
                for i in range(0, len(tavaraLista)):  #tavaroiden tutkiminen
                    if(action_input == "examine "+tavaraLista[i].lower()):
                        ...
                        time.sleep(1)
                for i in range(0, len(pelaajanTavarat)):
                    if(action_input == "examine "+pelaajanTavarat[i].lower()):
                        print("")
                        print("Examining "+pelaajanTavarat[i]+"....")
                        time.sleep(1)
                        print(tavaranTiedot(pelaajanTavarat[i]))
                        time.sleep(1)
...
class strange():  #ID 9, BOSS HUONE
    ...
    def kartta(self):
        elossa = checkAliveYksi(9)  #jos chimeraa ei olla tapettu
        if elossa == True:
            print("|-----north-----|")
            print("|               |")
            print("|    Living     |")
    ...
    def liikuN(self):
        ...
        if elossa==True:
            ...
            print("")
            print("")
            print("Congratulations you found the way out of dungeon!!")
            time.sleep(3)
            global peliLapaisty
            peliLapaisty = True
    def liikuS(self):
...
class stairWay(): #id 7
    ...
    def tutkittavaa(self):
        lista = ["Stairway", "Red Fountain"]
        return lista
    def tulos(self, string):
        st = ""
        if string == "Stairway":
            print("Stairways to hell, do not enter, but if you do, you do so by moving north!")
        if string == "Red Fountain":
            print("The fountain seems to have healing capabilities.")
            x = input("Do you want to heal your wounds y/n?: ")
            if x == "y":
                setPelaajaHP(str(100))
                print("Your HP was healed")
            if x == "n":
                print("You might want to rethink that")
        return st
...
class ropeBridge(): #id 6
    ...
    def tulos(self, string):
        st = ""
        if string == "Bridge":
            print("It's a bridge, and it looks like it will break any second. I need to make sure I don't have any extra weight on me...")
        return st
...
class TheCells():
    ...
    def tutkittavaa(self):
        lista = ["Cells","Skeleton"]
        return lista
    def tulos(self, string):
        st = ""
        if string == "Cells":
            print("Rows of old prison cells with skeletons in them, everyone is dead.")
        elif string == "Skeleton":
            print("Poor guy, died in these cells, he seems to be holding something though.")
            time.sleep(1)
            print("")
            print("")
            print("")
            print("It's a piece of paper")
            keraaItem("Piece of paper")
        return st
    
    def tavarat(self):  #Mitä tavaroita huoneessa on
        tavaraLista = []
        cur = db.cursor()
        sql = "SELECT name FROM itemtype, item WHERE itemtype.ITID = item.ITID AND item.TileID = 8;"
        cur.execute(sql)
        result = cur.fetchall()
        for row in result:
            tavaraLista.extend(row)
...
class Treasury(): #id 4
    ...
    def liikuE(self):
        ...
        if elossa == False:
            ...
            cur.execute(sql3)
            print("There is a man on the other side of the door, he asks you for a password.")
            P = input("Password: ")
            if P == "feather":
...
def kauppa():
    ...
    if x == "buy":
        ...
        print("")
        print("")
        print("Shopkeeper: That's my dearest treasure. Stay away from it, it's not for sale!")
        time.sleep(1)
        print("")
        print("")
        ...
        while vastaus==True:
            ...
            if x=="1":
                print("")
                print("")
                print("I have other stuff though if you need")
                time.sleep(1)
                vastaus=False
            elif x=="2":
                print("")
    ...
    while(vihutElossa == True and pelaajaElossa==True):
        ...
        if tee=="fight": # or "f":
            ...
            if huoneId == 4:
                if x == "hit":
                    dmg = Attack2
                    pelaajaIske(200, vihuId, 4)
                    time.sleep(1)
                elif x == "spell":
                    dmg = kaytaTaika()
                    pelaajaIske(dmg*0.5, vihuId, 4)
                    time.sleep(1)
                elif x == "charisma":
                    eff = kaytaCharisma()
            ...
            if huoneId == 9:
                if x == "hit":
                    dmg = Attack2
                    pelaajaIske(200, vihuId, 9)
                    time.sleep(1)
                elif x == "spell":
                    dmg = kaytaTaika()
                    pelaajaIske(dmg, vihuId, 9)
                    time.sleep(1)
                elif x == "charisma":
                    eff = kaytaCharisma()
                    pelaajaCH(eff, vihuId, 9)
                    time.sleep(1)
                               #odota 1 sekunti
